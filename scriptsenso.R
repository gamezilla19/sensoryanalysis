  ...
  tryCatch({
    if(!dbExistsTable(con, "product_info")) {  # Minuscules
      dbExecute(con, "CREATE TABLE IF NOT EXISTS product_info (
        ...
        ref VARCHAR(10),
        dosage VARCHAR(50),
        internal_name_additional_product VARCHAR(255),
        perfumer_code_additional_product VARCHAR(255),
        internal_code_additional_product VARCHAR(255),
        external_name_additional_product VARCHAR(255),
        external_code_additional_product VARCHAR(255),
        dosage_additional_product VARCHAR(255),
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
      )")
  ...
  tryCatch({
    ...
    product_info <- raw_data %>%
      ...
      mutate(
        ...
        ref = "",
        dosage = "",
        internal_name_additional_product = "",
        perfumer_code_additional_product = "",
        internal_code_additional_product = "",
        external_name_additional_product = "",
        external_code_additional_product = "",
        dosage_additional_product = ""
      ) %>%
